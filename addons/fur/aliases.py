...
api.register_alias('hello', template={
    '': 'Welcome to the Fuel rats, {first_arg}. Please tell us once you\'ve '
        ...
        'right.',
    'de': 'Willkommen bei den Fuel Rats, {first_arg}. Bitte sage bescheid, '
    ...
    'es': 'Bienvenido/a a las Fuel Rats, {first_arg}. Por favor, dime cuando '
    ...
    'it': 'Benvenuto/a presso i Fuel Rats, {first_arg}. Per cortesia avvisaci '
...
api.register_alias(
    'qmodules',
    template='{first_arg}: how are those modules coming up? :) Would you like '
...
api.register_alias(
    'open',
    template='{first_arg}: please exit to the main menu and log back in to '
             'OPEN '
...
api.register_alias(
    'qbc',
    template='{first_arg}: how is that wing beacon coming along, are there '
             'any '
             'issues? :)',
)
api.register_alias(
    'qo2',
    template='{first_arg}: do you see an "oxygen depleted in ..." timer in '
             'the '
             'top right of your HUD?',
)
api.register_alias(
    'qsys',
    template='{first_arg}: please, look in the left panel in the navigation '
             'tab '
...
api.register_alias(
    'mm',
    template='{first_arg}: from THIS point onwards, remain logged out in the '
...
api.register_alias(
    'qmmo2',
    template='{first_arg}: staying in the MAIN MENU, do you remember how much '
             'O2 you had left?',
)
api.register_alias(
    'qmmo2alt',
    template='{first_arg}: staying in the MAIN MENU, do you remember if the '
             'game asked you to wait for 15 seconds before letting you exit '
             'into main menu?',
)
api.register_alias(
    'qmmpos',
    template='{first_arg}: staying in the MAIN MENU, can you remember WHERE '
             'in '
...
api.register_alias(
    'crplan',
    template='{first_arg}: please, STAY in the MAIN MENU. Overall plan will '
             'be: '
...
api.register_alias(
    'gogogo',
    template='{first_arg}: GO GO GO! 1. Login to OPEN - 2. light your beacon '
             '- '
             '3. invite your rat(s) your wing: {rest_args} - 4. report your '
...
api.register_alias(
    'ls',
    template='{first_arg}: please turn your Life Support on immediately: go '
             'to '
...
api.register_alias(
    'sc',
    template='{first_arg}: looks like you\'re too close to a stellar body or '
             'a '
...
api.register_alias(
    'eta',
    template='{first_arg}: your rats will be with you in about {rest_args}, '
...
api.register_alias(
    'bounce',
    template='{first_arg}: if you are using a mobile device or table for this '
...
api.register_alias(
    'fuel',
    template='{first_arg}: you should be receiving fuel now. Please remain '
             'with '
